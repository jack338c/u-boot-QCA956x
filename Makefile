...
LZMA = $(RPT_TOPDIR)/util/lzma/bin/lzma_linuxplat
...
ifneq (,$(findstring wpa4220v2, $(PRODUCT_NAME))) #{
	@echo '#define CONFIG_WPA4220_V2		1'		>>include/config.h
	@echo '#define IMAGE_WITH_TP_TAG		1'		>>include/config.h
	@echo '#define BOOT_KERNEL_OFFSET  $(FW_KERNEL_OFFSET)'		>>include/config.h
endif #}
ifneq (,$(findstring wpa4230pv1, $(PRODUCT_NAME))) #{
	@echo '#define CONFIG_WPA4230P_V1		1'		>>include/config.h
	@echo '#define IMAGE_WITH_TP_TAG		1'		>>include/config.h
	@echo '#define BOOT_KERNEL_OFFSET  $(FW_KERNEL_OFFSET)'		>>include/config.h
endif #}
ifdef pll
...
ifneq ($(NM_EXTRA_PARA_BASE),)
	@echo "#define NM_EXTRA_PARA_BASE "$(strip ${NM_EXTRA_PARA_BASE}) >>include/config.h
endif
ifneq ($(WEB_PLC_UPGRADE_FLAG),)
	@echo "#define WEB_PLC_UPGRADE_FLAG "$(strip ${WEB_PLC_UPGRADE_FLAG}) >>include/config.h
endif
endif
...
ifneq (,$(findstring wpa8730v1, $(PRODUCT_NAME))) #{
	@echo '#define CONFIG_WPA8730_V1		1'		>>include/config.h
	@echo '#define IMAGE_WITH_TP_TAG		1'		>>include/config.h
	@echo '#define BOOT_KERNEL_OFFSET  $(FW_KERNEL_OFFSET)'		>>include/config.h
...
ifneq (,$(findstring $(CFG_BOARD_TYPE), ap152 ap152_ar8033)) #{
	@echo '#define UART_RX18_TX22           1'      >>include/config.h
ifneq (,$(findstring wpa8630v1, $(PRODUCT_NAME))) #{
	@echo '#define CONFIG_WPA8630_V1		1'		>>include/config.h
	@echo '#define IMAGE_WITH_TP_TAG		1'		>>include/config.h
	@echo '#define BOOT_KERNEL_OFFSET  $(FW_KERNEL_OFFSET)'		>>include/config.h
endif #}

ifneq (,$(findstring wpa8630pv1, $(PRODUCT_NAME))) #{
	@echo '#define CONFIG_WPA8630P_V1		1'		>>include/config.h
	@echo '#define IMAGE_WITH_TP_TAG		1'		>>include/config.h
	@echo '#define BOOT_KERNEL_OFFSET  $(FW_KERNEL_OFFSET)'		>>include/config.h
endif #}

ifneq (,$(findstring wpa8630v2, $(PRODUCT_NAME))) #{
	@echo '#define CONFIG_WPA8630_V2		1'		>>include/config.h
	@echo '#define IMAGE_WITH_TP_TAG		1'		>>include/config.h
	@echo '#define BOOT_KERNEL_OFFSET  $(FW_KERNEL_OFFSET)'		>>include/config.h
endif #}

ifneq (,$(findstring wpa8630pv2, $(PRODUCT_NAME))) #{
	@echo '#define CONFIG_WPA8630P_V2		1'		>>include/config.h
	@echo '#define IMAGE_WITH_TP_TAG		1'		>>include/config.h
	@echo '#define BOOT_KERNEL_OFFSET  $(FW_KERNEL_OFFSET)'		>>include/config.h
endif #}

ifneq (,$(findstring wpa8730v2, $(PRODUCT_NAME))) #{
...
ifeq ($(ETH_HW_LED),1)
	@echo '#define ETH_HW_LED    1'	>>include/config.h
endif

ifeq ($(strip ${JTAG_DEBUG_DISABLE}),y)
	@echo '#define JTAG_DEBUG_DISABLE    1'	>>include/config.h
endif
...
clean:
	...
	rm -f httpd/fsdata.c
	rm -f nvram_mngr/product_info.c
