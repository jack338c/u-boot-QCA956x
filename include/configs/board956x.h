 ...
 */
/* system led gpio bit */
#define CONFIG_SYS_LED_BIT							21
#define CONFIG_SYS_LED_FUNCTION_ADDR				GPIO_OUT_FUNCTION5_ADDRESS
#define CONFIG_SYS_LED_FUNCTION_ENABLE_MASK			GPIO_OUT_FUNCTION5_ENABLE_GPIO_21_MASK


/* ethernet lan leds gpio bit */
#define CONFIG_LAN_LED_BIT_1						14
#define CONFIG_LAN_LED_FUNCTION_ADDR_1				GPIO_OUT_FUNCTION3_ADDRESS
#define CONFIG_LAN_LED_FUNCTION_ENABLE_MASK_1		GPIO_OUT_FUNCTION3_ENABLE_GPIO_14_MASK

#define CONFIG_LAN_LED_BIT_2						15
#define CONFIG_LAN_LED_FUNCTION_ADDR_2				GPIO_OUT_FUNCTION3_ADDRESS
#define CONFIG_LAN_LED_FUNCTION_ENABLE_MASK_2		GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_MASK

#define CONFIG_LAN_LED_BIT_3						16
#define CONFIG_LAN_LED_FUNCTION_ADDR_3				GPIO_OUT_FUNCTION4_ADDRESS
#define CONFIG_LAN_LED_FUNCTION_ENABLE_MASK_3		GPIO_OUT_FUNCTION4_ENABLE_GPIO_16_MASK

#define CONFIG_LAN_LED_BIT_4						17
#define CONFIG_LAN_LED_FUNCTION_ADDR_4				GPIO_OUT_FUNCTION4_ADDRESS
#define CONFIG_LAN_LED_FUNCTION_ENABLE_MASK_4		GPIO_OUT_FUNCTION4_ENABLE_GPIO_17_MASK

/* ethernet wan leds gpio bit */
#define CONFIG_WAN_LED_BIT							18
#define CONFIG_WAN_LED_FUNCTION_ADDR				GPIO_OUT_FUNCTION4_ADDRESS
#define CONFIG_WAN_LED_FUNCTION_ENABLE_MASK			GPIO_OUT_FUNCTION4_ENABLE_GPIO_18_MASK
#endif


#if defined(CONFIG_WDR5510_V1)
/*-----------------------------------------------------------------------
 * LED GPIO Bit
 */
/* system led gpio bit */
#define CONFIG_SYS_LED_BIT							17
#define CONFIG_SYS_LED_FUNCTION_ADDR				GPIO_OUT_FUNCTION4_ADDRESS
#define CONFIG_SYS_LED_FUNCTION_ENABLE_MASK		GPIO_OUT_FUNCTION4_ENABLE_GPIO_17_MASK
#endif
...
#define BOOTSTRAP_TEXT_BASE                0x80010000/*0x9f020000*/
#define CFG_BOOT_SECOND_BASE             0x9f020000
#else
...
#		define MTDPARTS_DEFAULT "board=AP152 mtdparts=spi0.0:320k(u-boot-and-env);ath-nand:512k(pad),1280k(uImage),7m(rootfs),128k(dummy),128k(caldata)"
#		define ATH_ROOT_DEV	"31:03"
...
#			define ATH_K_ADDR	0x9f300000
			 ...
			 */
#			define MTDPARTS_DEFAULT	"board=AP152 mtdparts=spi0.0:32k(u-boot1),32k(u-boot2),3008k(rootfs),896k(uImage),64k(mib0),64k(ART)"
...
#				define MTDPARTS_DEFAULT        "board=AP152 mtdparts=spi0.0:32k(u-boot),32k(u-boot-env),1024k(uImage),2880k(rootfs),64k(mib0),64k(ART)"
#			elif (FLASH_SIZE == 8)
#				define ATH_F_FILE        fs_name(${bc}-${BUILD_TYPE})
...
#				define ATH_K_FILE        vmlinux${bc}.lzma.uImage
#				define ATH_K_ADDR        0x9f010000
				/*changed by ZQQ, for TL-WPA8730 2016.4.8*/
...
#				define ATH_ROOT_DEV			"31:03"
#if defined(CONFIG_WPA8730_V2)
#				define MTDPARTS_DEFAULT     "mtdparts=ath-nor0:128k(factory-uboot),128k(u-boot),1024k(uImage),6784k(rootfs),64k(mib0),64k(ART)"
#else
#				define MTDPARTS_DEFAULT     "board=AP152 mtdparts=spi0.0:128k(factory-uboot),128k(u-boot),1024k(uImage),6784k(rootfs),64k(mib0),64k(ART)"
#endif
#else
...
#else
#				define MTDPARTS_DEFAULT     "board=AP152 mtdparts=spi0.0:128k(u-boot),1024k(uImage),6912k(rootfs),64k(mib0),64k(ART)"
#endif
#endif
...
#				define ATH_K_FILE        vmlinux${bc}.lzma.uImage
#				define ATH_K_ADDR        0x9f010000
#				define MTDPARTS_DEFAULT        "board=AP152 mtdparts=spi0.0:32k(u-boot),32k(u-boot-env),1024k(uImage),15168k(rootfs),64k(mib0),64k(ART)"
#			endif
#		endif
#	else
		// WARNING: Don't support now! TODO: implement it later.
...
#		define MTDPARTS_DEFAULT		"board=AP152 mtdparts=spi0.0:256k(u-boot),64k(u-boot-env),6336k(rootfs),1408k(uImage)," ATH_MTDPARTS_MIB0 ",64k(ART)"
#	endif
